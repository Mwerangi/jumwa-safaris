<?php include '../layouts/header.php'; ?>
   <section id="gallery" class="gallery mt-4">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h3>Five Days Zanzibar beach holiday</h3>
      </div>
  ...
  <span id="itenary" class="itenary">
    <div class="container" data-aos="fade-up">
      <div class="section-title">
        <p>
            This itinerary is for those who just want to go on a truly great beach holiday, Stay at the same hotel, or for the longer stays why not move to a second hotel to see a different part of the Zanzibar Beach Holiday  
            this is often of interest to honeymoon couples who want to stay somewhere really exclusive for a few days at the start of their honeymoon, but then move elsewhere for the rest of their stay to keep costs down.
        </p>
      </div>
      <div class="row">
        <div class="col col-md-6">
          <ul class="itenary-list">
            ...
            <li>
              <div data-bs-toggle="collapse" href="#itenary4" class="collapsed question">Day 4: Individual space<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              <div id="itenary4" class="collapse" data-bs-parent=".itenary-list">
                <p>
                    Today you will be having individual space and beach relaxing at Amani bungalow resort this is your individual space and free time on the beach hotel where you can plan to do anything on your own. 
                    There are different activities such as water sports that you can enjoy
                </p>
              </div>
            </li>
    
            <li>
              <div data-bs-toggle="collapse" href="#itenary5" class="collapsed question">Day 5: Airport transfer<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              <div id="itenary5" class="collapse" data-bs-parent=".itenary-list">
                <p>
                    Transfer to the airport after breakfast. Leisurely morning and prepare yourself to drive about one hour to the Zanzibar airport. Our driver will be there on time to pick you up and start driving towards the airport on agreed time. Make sure you end of the trip
                </p>
              </div>
            </li>
          </ul>
        ...
        <?php include '../components/package_info.php'; ?>
              <button type="button" class="btn btn-sm btn-outline-success mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="Five Days Zanzibar beach holiday"> Request Quotation </button>
                      ...
                      <form method="POST" action="views/processing/safari_booking.php">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="safari" name="safari" value="Five Days Zanzibar beach holiday">
                          </div>
                          <div class="col-md-6">
